...
<link href="<?php echo $public_r['newsurl']?>skin/default/css/style.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="<?php echo $public_r['newsurl']?>skin/default/js/tabs.js"></script>
</head>
<body class="listpage">
